...
$(document).ready(function() {
    // Set a flag to track whether the animation has occurred
    var animated = false;
...
function animateOnScroll() {
    $('.fade-in-right, .fade-in-left, .fade-in-up').each(function() {
        var point = "0px", side = "50px";
        var move = $(this).hasClass('fade-in-left') ? "-50px" : "50px";
        var moveUp = "50px";

        // Check if element is in view and not already animated
        if (isScrolledIntoView($(this)) && !$(this).hasClass('animated')) {
            $(this).addClass('animated'); // Add a class to mark as animated
